    ...
    <>
      <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          ...
          <p className='text-gray-400 mt-2 mx-auto max-w-md text-sm'>Start for free and scale up as you grow. Find the perfect plan for your content creation seeds.</p>
        </div>
